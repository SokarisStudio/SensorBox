...
#    sound_v = 20*math.log(sound_v0+1)
    sound_v = (sound_v0+83.2073)/11.003
#    if humidity is not None and temperature is not None:
    print("Temp={0:f} *C Humidity={1:f} %".format(temperature, humidity))
    print("Sound: "+str(sound_v))
...
#       print("Fail")
    ...
    payload={'api_key':'12345678',
             ...
             'location_id':'1',
             'client_id':'0',
             'value_temp':str(temperature)+' *C',
             'value_humidity':str(humidity)+' %',
             'value_light':str(readVisibleLux())+' lx',
